...
const App = () => {
  const [accelerationValue, setAccelerationValue] = useState(5); // Example dummy value
  const [gyroscopeValue, setGyroscopeValue] = useState(7); // Example dummy value
  ...
  useEffect(() => {
    ...
    acceleration.setInputValue(accelerationValue); // Use dummy value
    gyroscope.setInputValue(gyroscopeValue); // Use dummy value
